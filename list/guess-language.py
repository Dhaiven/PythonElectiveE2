...
def guess_language(text):
    ...
    frequencies = [text.count(letter) for letter in ascii_lowercase]
    ...
    for ref in LANGS:
        s = 0.0
        for i in range(26):
            d = (frequencies[i] * 100 / totalLetters) - ref[i]
            s += d * d
        diffs.append(s)
...
if __name__ == "__main__":
    print("Detected language for LCELR is :", guess_language(LCELR))
    print("Detected language for IF is :", guess_language(IF))
    print("Detected language for POEMAXX is :", guess_language(POEMAXX))
    print("Detected language for GOETHE is :", guess_language(GOETHE))